...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        ...
        PrimaryView="ControllerWorkplaceView">
        <CallbackCommands>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="ControllerWorkplaceView" Width="100%" Height="" AllowAutoHide="false">
        <Template>
            <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartRow="True"></px:PXLayoutRule>
            <px:PXSelector runat="server" ID="CstPXSelector2" DataField="RefNbr" />
            <px:PXSelector runat="server" ID="CstPXSelector1" DataField="InvoiceNbr" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Details" AllowAutoHide="false">
        ...
        <ActionBar>
            <CustomItems>
                <px:PXToolBarButton Text="Create Invoices">
                    <AutoCallBack Command="CreateInvoices" Target="ds"></AutoCallBack>
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="Create Preparation">
                    <AutoCallBack Command="CreatePreparation" Target="ds"></AutoCallBack>
                </px:PXToolBarButton>
            </CustomItems>
        </ActionBar>
    </px:PXGrid>
